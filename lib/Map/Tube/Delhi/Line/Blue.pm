...
$Map::Tube::Delhi::Line::Blue::VERSION   = '0.23';
...
=item * The station "Dwarka Sector 21" is also part of L<Orange Line|Map::Tube::Delhi::Line::Orange>.

=item * The station "Kirti Nagar" is also part of L<Green Line|Map::Tube::Delhi::Line::Green>.

=item * The station "Rajiv Chowk" is also part of L<Yellow Line|Map::Tube::Delhi::Line::Yellow>.
